...
SRCS		=	srcs/main.c srcs/executor.c srcs/exec_simple_cmd.c srcs/builtins1.c srcs/builtins2.c srcs/env_initiate.c srcs/env_utils.c srcs/dictionary.c \
				srcs/dictionary_utils.c srcs/dictionary_cleanup.c srcs/redirect.c srcs/cleanup.c srcs/parser.c srcs/tokenizer.c srcs/recurs_desc_parser.c
OBJS		=	${SRCS:.c=.o}
...
PARSE_TEST_SRCS	=	srcs/executor.c srcs/exec_simple_cmd.c srcs/builtins1.c srcs/builtins2.c srcs/env_initiate.c srcs/env_utils.c srcs/dictionary.c \
...
EXEC_TEST_SRCS	=	tests/executor/env_tests.c tests/executor/absolute_path_cmd_tests.c tests/executor/pipe_tests.c \
				...
				srcs/executor.c srcs/exec_simple_cmd.c srcs/builtins1.c srcs/builtins2.c srcs/env_initiate.c srcs/env_utils.c srcs/dictionary.c \
