...
CC			=	gcc
RM			=	rm -rf
SRCS		=	srcs/main.c srcs/exec.c srcs/builtins1.c srcs/builtins2.c srcs/env.c srcs/dictionary.c \
				srcs/dictionary_utils.c srcs/dictionary_cleanup.c srcs/redirect.c srcs/cleanup.c
OBJS		=	${SRCS:.c=.o}
LEX_TEST_SRCS	=	srcs/exec.c srcs/builtins1.c srcs/builtins2.c srcs/env.c srcs/dictionary.c \
...
PARSE_TEST_SRCS	=	srcs/exec.c srcs/builtins1.c srcs/builtins2.c srcs/env.c srcs/dictionary.c \
...
EXEC_TEST_SRCS	=	tests/executor/env_tests.c tests/executor/absolute_path_cmd_tests.c tests/executor/pipe_tests.c \
				...
				srcs/exec.c srcs/builtins1.c srcs/builtins2.c srcs/env.c srcs/dictionary.c \
				srcs/dictionary_utils.c srcs/dictionary_cleanup.c srcs/redirect.c srcs/cleanup.c
...
exec_tester:	$(EXEC_TEST_OBJS) $(LIB)
		$(CC) -g -fsanitize=address $(CFLAGS) -I ../inc/minishell.h -lreadline $(EXEC_TEST_OBJS) $(LIB) -lreadline -o minishell
clean:
